...
<script type="text/javascript">
	...
	function getItemsContainerPageContent(url) {
	...
	function selectedCategory(id){
		for(var i=0; i<20;i++){
			if(document.getElementById("anc"+i)){
				document.getElementById("anc"+i).style.color = "#000000";
			}
		}
...
<div id="leftnav">
      <div class="navbar">
        <!-- *********************************Start Menu****************************** -->
        <div id="leftmenu">Top Selling Categories</div>
			<div id="navcontainer">
				  <ul >
				  ...
				  <%for(int i=0;i<categoryList.size();i++){%>
					<li>
					<a id="anc<%=i%>" href='javascript:selectedCategory(<%=i%>);getItemsContainerPageContent("itemsContainer.jsp?itemIndex=<%=i%>");'>
    ...
    <div id="tabulardata">
    <jsp:include page="itemsContainer.jsp"></jsp:include>
    </div>
    <div id="mealorder">
