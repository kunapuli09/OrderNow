...
<link href="<s:url value='/css/flexcrollstyles.css'/>" media="screen"
	rel="Stylesheet" type="text/css">
...
%>
<body class="inner"
	onLoad="MM_preloadImages('../images/home_r.gif','../images/ordernow_r.gif','../images/cateringorders_r.gif','../images/updatecontent_r.gif','../images/updateservices_r.gif','../images/showorders_r.gif','../images/directions_r.gif','../images/logout_r.gif')">

<tlt:resource email="<%=emailToken %>"></tlt:resource>
<div id="body">
	<div id="wrapper">
		<div id="header">
			<div id="logo"><a href="starpathTemplate.jsp"><img	src="../images/logo.png" alt="Sai Grocery" width="205" height="150" /></a></div>
			<div id="topnavigation">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<td width="66" align="right" valign="top"><a
						...
						height="33" id="Image4"
						onMouseOver="MM_swapImage('Image4','','../images/myaccount_r.gif',1)"
						onMouseOut="MM_swapImgRestore()" /></a></td>
		...
		<div id="banner"><img src="../images/Banner_01.jpg" alt="Banner"
			...
			src="../images/Banner_04.jpg" alt="Banner" width="250" height="219" />
		</div>
		<div id="bodycontent"> 
		<div id="left"><p class="bold">Welcome to Sai Groceries Online.</p><p>
		...
		On Wednesdays and Thursdays fresh vegetables are available!<br/>
		Also a good quality brand new DVDs available at affordable price. Movies from Telugu, Tamil and Hindi are available.
		</p><br/><br/></div>
		<div id="center"><img src="../images/restaurenttimings.gif"	alt="Store Timings" /><p>
	Tue - Fri (3:00PM – 8:00 PM)<br />
 	Sat - Sun (12:00 PM – 08:00 PM)
 	</p>
