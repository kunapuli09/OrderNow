...
<div id="leftnav" >
      <div class="navbar" >
        <!-- *********************************Start Menu****************************** -->
        <div id="leftmenu">Menu Details</div>
			<div id="navcontainer" >
				  <ul >
				  ...
				  <%for(int i=0;i<categoryList.size();i++){%>
					<li>
					<a href='javascript:getItemsContainerPageContent1("itemsContainer1.jsp?itemIndex=<%=i%>");'>
								&nbsp;<%=categoryList.get(i).getName() %></a>
					</li>
					<%} %>
				  </ul>
			</div>
 ...
 <script>
        ...
        if(parent.document.getElementById("ordernowbg")){
                ...
                parent.document.getElementById("ordernowinnerbg").innerHTML = '<div id="leftblock"><span class="bold">Lunch Buffet</span><br/> Tue- Sun (11:30 AM - 03:00 PM)</div> <div id="rightblock"><span class="bold">Dinner</span><br/>   Tue - Sat (05:30 PM - 10:00 PM)<br/>   Sun (05:30 PM - 09:30 PM)</div> <div id="todayspecial_inner">Join us for Sunday Lunch Buffet 12-3PM</div> <div></div>';
        }
