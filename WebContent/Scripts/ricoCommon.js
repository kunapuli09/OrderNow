...
if (typeof Rico=='undefined'){
	//alert("Cannot find the Rico object");
  throw("Cannot find the Rico object");
}
if (typeof Prototype=='undefined'){
	//alert("Rico requires the Prototype JavaScript framework");
...
if (Rico.prototypeVersion < 1.3){
	//alert("Rico requires Prototype JavaScript framework version 1.3 or greater");
