...
var flyingSpeed = 25;
var url_addProductToBasket = 'addProduct.jsp';
...
function ajaxAddProduct(productId)
{
	...
	ajaxObjects[ajaxIndex].onCompletion = function(){ alart(productId); showAjaxBasketContent(ajaxIndex); };	// Specify function that will be executed after file has been found
	ajaxObjects[ajaxIndex].runAJAX();		// Execute AJAX function		
}