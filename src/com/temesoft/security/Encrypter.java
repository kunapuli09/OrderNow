 ...
 * the more popular algorithms are: <li>Blowfish <li>DES <li>DESede <li>
 * PBEWithMD5AndDES <li>PBEWithMD5AndTripleDES <li>TripleDES </b>
 */
public class Encrypter {

	private static final String PASS_CODE = Config
			.getProperty(Config.PASS_CODE);
	...
	public Encrypter() {
		// 8-bytes Salt
		byte[] salt = { (byte) 0xAA, (byte) 0x9B, (byte) 0xC8, (byte) 0x32,
		...
		try {
			...
			KeySpec keySpec = new PBEKeySpec(PASS_CODE.toCharArray(), salt,
					iterationCount);
			SecretKey key = SecretKeyFactory.getInstance(
					Config.getProperty(Config.ALGORITHM)).generateSecret(
					keySpec);
